    ...
    StatementTranspiler.prototype.visitNode = function (node) {
        switch (node.kind) {
            ...
            case 189 /* ContinueStatement */:
                ...
                this.emit(breakContinue.kind == 190 /* BreakStatement */ ? 'break' : 'continue');
            ...
            case 195 /* ThrowStatement */:
                var throwStmt = node;
                var surroundingCatchClause = this.getAncestor(throwStmt, 223 /* CatchClause */);
