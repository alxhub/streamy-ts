...
var DeclarationTranspiler = (function (_super) {
    ...
    function DeclarationTranspiler(tr) {
        _super.call(this, tr);
    }
        ...
        switch (node.kind) {
            ...
            case 135 /* Constructor */:
                ...
                for (var parent = ctorDecl.parent; parent; parent = parent.parent) {
                    if (parent.kind == 201 /* ClassDeclaration */) {
            ...
            case 163 /* ArrowFunction */:
                ...
                if (arrowFunc.body.kind == 179 /* Block */) {
            ...
            case 129 /* Parameter */:
                ...
                if (paramDecl.name.kind === 150 /* ObjectBindingPattern */) {
    ...
    DeclarationTranspiler.prototype.visitParameters = function (parameters) {
        ...
        for (; firstInitParamIdx < parameters.length; firstInitParamIdx++) {
            ...
            if (isOpt && parameters[firstInitParamIdx].name.kind !== 150 /* ObjectBindingPattern */) {
                break;
            }
        }
    ...
    DeclarationTranspiler.prototype.visitClassLike = function (keyword, decl) {
        ...
        decl.members.filter(function (m) { return m.kind == 135 /* Constructor */; })
        ...
        if (this.isConst(decl) && !decl.members.some(function (m) { return m.kind == 135 /* Constructor */; })) {
            this.emit("const");
            this.visitTypeName(decl.name);
            this.emit("();");
        }
    ...
    DeclarationTranspiler.prototype.visitDecorators = function (decorators) {
        ...
        decorators.forEach(function (d) {
            ...
            if (!name && d.expression.kind === 157 /* CallExpression */) {
                // Unwrap @CONST()
    ...
    DeclarationTranspiler.prototype.visitNamedParameter = function (paramDecl) {
        ...
        this.visit(paramDecl.name);
        if (paramDecl.initializer) {
            if (paramDecl.initializer.kind !== 154 /* ObjectLiteralExpression */ ||
